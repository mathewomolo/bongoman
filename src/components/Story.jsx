    ...
    <section className="story" id="story" ref={sectionRef}>
      ...
      <div className="container">
        ...
        <div className="story__panels">
          ...
          >
            <span className="story__panel-year">1989</span>
          ...
          >
            <span className="story__panel-year">Now</span>
        ...
        >
          The answer is a 2D action platformer built out of the world Kham has drawn for over
          thirty years, rebuilt as a place you can run through, climb and fight your way
          across.
        </motion.p>
      </div>
    </section>
